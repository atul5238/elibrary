<div class="d-flex bg-light py-5 bg-dark" style="min-height:calc(100% - 180px);">
	<div class="my-auto w-100">
		<form method="POST" action="/change_password"  class="border border-secondary p-4 rounded bg-white col-md-5 col-sm-7 col-9 col-xl-4 mx-auto">
			...
			<input type="password" class="form-control mt-2" id="password1" placeholder="Confirm Password *" name="password1" >
