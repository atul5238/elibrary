 <div class="border border-secondary p-4 rounded bg-dark text-white col-sm-6 col-9 col-lg-12 mx-auto">
     <form action="/registration" method="post" >
         ...
         <input type="password" class="form-control  mt-2" name="rpassword" id="rpassword" placeholder="Enter Password *" value="<?= $password ?>" required>
         <small id="errorrpassword" class="form-text text-muted text-danger"><?= $msg3 ?></small>
         <input type="password" class="form-control  mt-2" name="password1" id="password1" placeholder="Confirm Password *" required>
