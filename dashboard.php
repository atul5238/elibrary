...
<body>
    <div class="header">
        <div class="container">
            ...
            text-align: center;margin-bottom: 0%;">ADMIN'S DASHBOARD</h1>
        </div><br><br>
    </div>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="admin_shelf.php">Book Shelf</a>
                    </li>
                    <li class="nav-item">
